...
| HPNET Duyệt dự thảo | Windows Forms + Node | `HPNet-Duyet-VB-Du-Thao.ps1` | Full scan and sequential approval | `nodes_tools/Duyet/app_icon.ico` | Window icon + `HPNET.VBDLIS.Tools.Approve` | Multiple title phrases (contains), two-step gate, real progress, live output, default icon |
