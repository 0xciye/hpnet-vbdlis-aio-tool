...
def build_story(s):
        ...
        [
            ...
            data_table(
                [
                    ...
                    ["Giới tính", "Tự động", "Chỉ lấy từ CCCD 12 số: chữ số thứ 4 là 0/2 thì Nam, 1/3 thì Nữ; CMND 9 số để trống."],
        ...
        [
            ...
            data_table(
                [
                    ...
                    ["0", "Nam — sinh trong thế kỷ 20"],
                    ["1", "Nữ — sinh trong thế kỷ 20"],
                    ["2", "Nam — sinh trong thế kỷ 21"],
                    ["3", "Nữ — sinh trong thế kỷ 21"],
                    ["4 đến 9", "Để trống"],
                    ["CMND 9 số, CCCD thiếu hoặc không đủ 12 chữ số", "Để trống"],
                ],
                [95, 77], s,
            ),
        ...
        [
            ...
            data_table(
                [
                    ...
                    ["CCCD/CMND không hợp lệ", "Kiểm tra đủ 9 hoặc 12 chữ số. Không thêm số 0 bằng phỏng đoán."],
        ...
        [
            ...
            bullets(
                [
                    ...
                    "Giới tính (Mục 10): với CCCD 12 số, số thứ 4 là <b>0/2 thì Nam</b>, <b>1/3 thì Nữ</b>, còn lại để trống. CMND 9 số không suy ra giới tính.",
        ...
        [
            ...
            data_table(
                [
                    ...
                    ["Giới tính theo số thứ 4 của CCCD 12 số: 0/2 = Nam, 1/3 = Nữ; CMND 9 số để trống", "[   ]"],
    ...
    story.extend(
        [
            ...
            para("<b>Tại sao Giới tính bị để trống?</b><br/>Chỉ CCCD đủ 12 chữ số có số thứ 4 là 0/2 (Nam) hoặc 1/3 (Nữ) mới được điền giới tính. CMND 9 số và các trường hợp khác để trống, kể cả khi file nguồn có ghi giới tính.", s["body"]),
