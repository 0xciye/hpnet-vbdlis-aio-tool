...
class SettingsPage(QWidget):
    ...
    def __init__(self):
        ...
        self.invalid_cccd.addItem("Dừng nếu không đủ 9 hoặc 12 số", "error")
        ...
        self.skip_invalid_data.setToolTip("Thiếu họ tên/CCCD hoặc tờ/thửa/diện tích: bỏ cả hộ. CCCD/CMND có giá trị nhưng không đủ 9 hoặc 12 số: bỏ riêng người. Không kiểm tra ô trống bình thường ở dòng nối tiếp như một người/thửa mới.")
        ...
        gender_note = QLabel("Tự động từ CCCD 12 số: số thứ 4 là 0/2 → Nam, 1/3 → Nữ.\nCMND 9 số, số khác hoặc CCCD không đủ 12 chữ số → để trống.")
